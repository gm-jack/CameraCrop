...
public class SmartCropper {
    ...
    public static void closeDelegate() {
        if (sImageDetector != null)
            sImageDetector.delegateClose();
    }

    public static double getBlurry(Bitmap srcBitmap) {
        return nativeBlurry(srcBitmap);
    }

    public static float[] getLight(Bitmap srcBitmap) {
        return nativeLight(srcBitmap);
    }
    ...
    private static native double nativeBlurry(Bitmap srcBitmap);

    private static native float[] nativeLight(Bitmap srcBitmap);
